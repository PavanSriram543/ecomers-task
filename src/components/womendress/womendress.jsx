        ...
        <div className="container pt-3 pb-3">
          ...
          <div className="row pt-1">
            <div className="col-xl-5 col-lg-5 text-center pt-5 hide-popular">
              <Link>
                <img
                  src="./images/WomenDress/ladies-dress.jpg"
                  height="400px"
                  data-aos="fade-up"
                />
                <br />
            ...
            <div className="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
              <div className="row">
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 text-center pt-3">
                  <Link>
                    <img
                      src="./images/WomenDress/ladies-dress-1.jpg"
                      height="200px"
                      data-aos="fade-up"
                    />
                    <br />
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 text-center pt-3">
                  <Link>
                    <img
                      src="./images/WomenDress/ladies-dress-2.jpg"
                      height="200px"
                      data-aos="fade-up"
                    />
                    <br />
              ...
              <div className="row">
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 text-center pt-3">
                  <Link>
                    <img
                      src="./images/WomenDress/ladies-dress-3.jpg"
                      height="200px"
                      data-aos="fade-up"
                    />
                    <br />
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 text-center pt-3">
                  <Link>
                    <img
                      src="./images/WomenDress/ladies-dress-4.jpg"
                      height="200px"
                      data-aos="fade-up"
                    />
                    <br />
